		...
		if (array_key_exists('title',$attributes)) {
			...
			if ($sermons) {
				...
				foreach ($sermons as $sermon) {
					...
					if ($i==0) {$HTML .= '<td style="width:16%" class="sml">';} else {$HTML .= '<td class="sml">';}
